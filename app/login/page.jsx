        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <Button
              type="submit"
              fullWidth
              className='outline_orange_btn_grey_border uppercase py-2 px-4  font-semibold cursor-pointer border-2 w-full  transition duration-200 ease-in-out'
              sx={{ mt: 3, mb: 2 }}
            >
              Sign In
            </Button>
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <button
                    type="button"
                    className="google_btn w-full  flex justify-center items-center p-3  cursor-pointer outline-none uppercase py-2 px-4  mt-4 mb-4   border-2 transition duration-200 ease-in-out"
