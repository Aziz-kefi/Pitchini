...
function Search() {
  ...
  return (
   ...
   available.</motion.p>
      ...
      <motion.form    initial={{ opacity: 0 , scale:0.5 }} whileInView={{ opacity: 1 , scale:1 }}  transition={{ duration: 0.5  }} className='relative w-2/3 flex-center mb-12'>
        <input
          type='text'
          placeholder='Search and find your needs in our categories and sub-categories'
